...
SECRET_KEY = 'django-insecure-rce)shi7-r3o7=rs$9&x1^j4c=lb_g2$jg!h*nz4yvom0lx@+@'
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": False,                   # Keep refresh token same
    "BLACKLIST_AFTER_ROTATION": True,                 # Blacklist old tokens if rotated
